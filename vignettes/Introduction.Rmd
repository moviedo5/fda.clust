...
The `fda.clust` package provides specialized clustering methods for functional data. 
Inspired by the functional data analysis framework, it offers tools for:
